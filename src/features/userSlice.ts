...
const userSlice = createSlice({
	...
	reducers: {
		...
		login: (state, action: PayloadAction<ILogin>) => {
			...
			const lastActiveChat = action.payload.lastActiveChat || {}
